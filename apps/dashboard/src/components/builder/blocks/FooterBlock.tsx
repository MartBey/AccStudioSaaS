    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Copyright */}
          <p style={{ fontSize: "13px", margin: 0, opacity: 0.7, textAlign: "center" }}>{text}</p>
        </div>
      </footer>
    </div>
  );
...
const FooterSettings = () => {
  ...
  return (
    <div className="flex flex-col gap-4 rounded-md border bg-card p-4 text-card-foreground">
      <h3 className="text-sm font-semibold">Footer Settings</h3>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            onChange={(e) =>
              setProp((props: FooterBlockProps) => (props.backgroundColor = e.target.value))
            }
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            value={textColor}
            onChange={(e) =>
              setProp((props: FooterBlockProps) => (props.textColor = e.target.value))
            }
            className="h-8 w-8 rounded border"
          />
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          checked={showSocials}
          onChange={(e) =>
            setProp((props: FooterBlockProps) => (props.showSocials = e.target.checked))
          }
          className="rounded"
        />
